...
def login():
	...
	console.print(nel(f"""         [bold purple]IP Address:{N} {data['ip']}
        [bold purple]Region:{N} {data['region']}
        [bold purple]Location:{N} {data['loc']}
        [bold purple]City:{N} {data['city']}
        [bold purple]Timezone:{N} {data['timezone']}""",width=70,padding=(0,7),style=f"{color_panel}"))
