...
def login():
	...
	print(nel("""[bold blue]IP Information[bold blue]
        {U]IP Address:{N} {data['ip']}
        {U}Region:{N} {data['region']}
        {U}Location:{N} {data['loc']}
        {U}City:{N} {data['city']}
        {U}Timezone:{N} {data['timezone']}""",width=70,padding=(0,7),style=f"{color_panel}"))
