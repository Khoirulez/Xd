...
def login():
	...
	os.system('clear')
	banner()
	cetak(nel('\t>>{U} Your Name{N} : {ip_address}'))
	print(f'>>{U} Your Idz{N} : {ip_address}')
	print(f'>>{U} Your Ip{N}  : {ip_address}')
	print(f'>>{U} Your Region{N} : {region}')
	print(f'>>{U} Your location{N} : {location}')
