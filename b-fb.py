...
def login():
    ...
    print(nel(f"""[bold cyan]Your IP: [bold green]{cek_data} [bold cyan]Region: [bold green]{asal_reg} [bold cyan]Kota: [bold green]{city} [bold cyan]Timezone: [bold green]{times}""",width=70, padding=(0, 7), style=f"{color_panel}"))
...
[{color_text}03{P2}] Clone ID Email  [{color_text}00{P2}] Exit Program""",width=70,padding=(0,7),style=f"{color_panel}"))
