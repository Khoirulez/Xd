...
def atur_method():
	print("")
	print(f"\n{biru}╭────────────────────────────────────────────{puti}")
	print(f'{biru}└──[{puti} {mer}01.{puti} m.prod.facebook.com [[green]ON[white]] ')
	print(f'{biru}└──[{puti} {mer}02.{puti} m.facebook.com [[green]ON[white]]')
	print(f"{biru}╭────────────────────────────────────────────{puti}") 
